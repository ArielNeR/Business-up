...
namespace PruebaPDF.Droid.Pdf
{
    ...
    {
        public static string fileName = "Ejercicios_MN.pdf";
        ...
        {
            Stream inputStream = new MemoryStream(PdfData.pdfContent);
            ...
            var v = LayoutInflater.From(Platform.AppContext).Inflate(Business_Up.Droid.Resource.Layout.pdf_fragment, null);
            mRecyclerView = v.FindViewById<RecyclerView>(Business_Up.Droid.Resource.Id.recyclerView);
